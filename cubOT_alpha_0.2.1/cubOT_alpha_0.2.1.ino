...
inline void createData() {
  ...
  vals[1] = (int16_t)(((AcY + 32768) / 65536.0) * 360 - 180);
  vals[2] = (int16_t)(((AcZ + 32768) / 65536.0) * 360 - 180);
  vals[3] = (int16_t)(((GyX + 32768) / 65536.0) * 360 - 180);
  vals[4] = (int16_t)(((GyY + 32768) / 65536.0) * 360 - 180);
  vals[5] = (int16_t)(((GyZ + 32768) / 65536.0) * 360 - 180);
  vals[6] = (int16_t)(((MaX + 32768) / 65536.0) * 360 - 180);
  vals[7] = (int16_t)(((MaY + 32768) / 65536.0) * 360 - 180);
  vals[8] = (int16_t)(((MaZ + 32768) / 65536.0) * 360 - 180); 
